...
from utils.exceptions import DeviceError, DeviceConnectionError
...
class TestDeviceServiceAsync:
    ...
    @patch('services.device.GLib')
    def test_connect_device_async_unreachable(self, mock_glib, mock_port, device_service):
...
class TestDeviceServiceIdentification:
    ...
    def test_identify_samsung_device_success(self, mock_urlopen, device_service):
        ...
        mock_response.read.return_value = b'{"device": {"name": "Samsung TV", "modelName": "UN55TU8000"}}'
